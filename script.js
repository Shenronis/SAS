$(document).ready(function () {
    ...
    if (isMobile()) {
        ...
        if( ios ) {
            if ( !safari ) {
                $("li").css("margin-bottom", "5.5em");
            };
        }
    }
    else{
        $(".hero-text #1").html("Student Against Sleep");
        $(".hero-text #2").html("Student Against Sleep");
        $(".hero-text h2").html("CHANGELOGGG");

        $(".hero-text #1").css("font-size", "100px");
        $(".hero-text #2").css("font-size", "100px");
    }
});
